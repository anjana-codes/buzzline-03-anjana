...
py -m producers.json_producer_anjana
```
...
```zsh
source .venv/bin/activate
python3 -m producers.json_producer_anjana
```
...
```shell
.venv\Scripts\activate
py -m consumers.json_consumer_anjana
```
...
```zsh
source .venv/bin/activate
python3 -m consumers.json_consumer_anjana
```
...
```shell
.venv\Scripts\activate
py -m producers.csv_producer_anjana
```
...
```shell
.venv\Scripts\activate
py -m consumers.csv_consumer_anjana
```
